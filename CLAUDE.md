...
- `archive/` — **exploratory and superseded; do not quote anything from it.** Kept for provenance (it records what was ruled out along the way, which is what answers "how did you rule that out?"). `archive/README.md` explains each notebook's original purpose. Two traps in particular:
