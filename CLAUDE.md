...
- `demo/` — Colab notebooks (`.ipynb`) demonstrating getting-started flows for both backends, MLflow, reach & frequency, and scenario planning; these are the canonical end-to-end usage examples.
